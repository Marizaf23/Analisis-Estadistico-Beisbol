---CUESTIONARIO SQL - TRABAJO FINAL: SALUD MENTAL EN LA INDUSTRIA TECNOLÓGICA---
...
CREATE VIEW "PREGUNTA #1 - GRUPO #2" AS
SELECT
...
CREATE VIEW "PREGUNTA #2 - GRUPO #2" AS
SELECT 
  CASE 
...
CREATE VIEW "PREGUNTA #3 - GRUPO #2" AS
WITH
...
CREATE VIEW "PREGUNTA #4 - GRUPO #2" AS
SELECT 
...
CREATE VIEW "PREGUNTA #5 - GRUPO #2" AS
SELECT 
  R1.SurveyID AS Año,
  SUM(CASE 
