...
if option == 'Diagnosticadas':
    ...
    st.dataframe(Trabajo2016_4_1, width=1000, height=470, hide_index=True)
    st.plotly_chart(fig20164_3, use_container_width=True)

    st.dataframe(Pregunta4_1, width=1000, height=512, hide_index=True)
...
if option == 'No Diagnosticadas':
    ...
    st.dataframe(Trabajo2016_4_2, width=1000, height=422, hide_index=True)
