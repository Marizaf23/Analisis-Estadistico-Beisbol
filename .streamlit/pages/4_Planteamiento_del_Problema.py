...
objectives = [
    ...
    "¿Cuál es la disposición de los empleados de la industria tecnológica a a hora de hablar sobre su enfermedad mental y cómo creen que serían las reacciones externas?",
